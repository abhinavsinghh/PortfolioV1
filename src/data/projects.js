export const projects = [
  {
    ...
    description:
      "A secure, Dockerized REST API for managing tasks with JWT authentication, PostgreSQL, Redis caching, Celery background jobs, and automated CI/CD.",
    image: "TaskMAnagementAPI.png",
    tech: [
      "Python",
      "FastAPI",
      "PostgresSQL",
  ...
  },
  {
    ...
    tech: ["Python", "Streamlit", "Langchain", "Ollama", "Hugging Face", "BeautifulSoup", "Git"],
    // liveUrl: 'https://example.com',
